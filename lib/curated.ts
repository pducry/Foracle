...
export const CURATED: CuratedCategory[] = [
  {
    ...
    fonts: [
      ...
      { id: "neue-montreal", tier: "essential", badge: "Pangram Hit", reason: "Pangram Pangram's most cited free font. Premium neo-grotesk. Freefaces.gallery featured." },
      { id: "switzer", tier: "rising", badge: "Freefaces Pick", reason: "Swiss-style neo-grotesk from Fontshare. 9 weights. Clean, neutral, professional." },
      { id: "overused-grotesk", tier: "rising", badge: "Indie Gem", reason: "Open-source grotesk by Random Maerz. Raw, honest, anti-corporate. GitHub favorite." },
  ...
  },
  {
    ...
    fonts: [
      ...
      { id: "zodiak", tier: "rising", badge: "Freefaces Pick", reason: "Fontshare's editorial serif. High contrast, dramatic. Featured on freefaces.gallery." },
      { id: "bluu-next", tier: "rising", badge: "Indie Bold", reason: "Bold serif by Jean-Baptiste Morizot. One weight, maximum character. Freefaces.gallery staple." },
      { id: "erode", tier: "rising", badge: "Fontshare", reason: "Transitional serif with modern sensibility. 5 weights. Clean editorial choice." },
    ],
  },
  {
    id: "display",
    ...
    fonts: [
      ...
      { id: "basement-grotesque", tier: "rising", badge: "Freefaces Star", reason: "Ultra-bold display by Basement Studio. Unique character. Open-source. Community favorite." },
      { id: "humane", tier: "rising", badge: "Fontshare", reason: "Condensed display with 8 weights. Dramatic, impactful. Featured on freefaces.gallery." },
      { id: "neue-machina", tier: "rising", badge: "Pangram", reason: "Mechanical display font. Futuristic, technical. Pangram Pangram's free trial hit." },
